...
import dagshub
dagshub.init(repo_owner='alimoazzam123', repo_name='MLOPS-with-MLFLOW', mlflow=True)

mlflow.set_tracking_uri("https://dagshub.com/alimoazzam123/MLOPS-with-MLFLOW.mlflow")
